...
// @Autonomous(name="DcMotorExTry1", group="2020/2021 auto programms") 
// public class DcMotorExTry1 extends LinearOpMode {
...
//     DcMotorExHardwareMap robot = new DcMotorExHardwareMap();
...
//     public static final double NEW_I = 20;
...
//         // frontLeft = hardwareMap.get(DcMotor.class, "NeveRest");
//         waitForStart();
...
//             robot.frontLeft.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER,pidNew);
            
//             PIDFCoefficients pidModified =
//         robot.frontLeft.getPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER);
        
//         robot.backLeft.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER,pidNew);
            
//         robot.backLeft.getPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER);
        
//         robot.frontRight.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER,pidNew);
            
//         robot.frontRight.getPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER);
        
//         robot.backRight.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER,pidNew);
            
//         robot.backRight.getPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER);
        
//         // robot.frontLeft.setVelocity(-.39*2880.2);
//         // robot.backLeft.setVelocity(-.39*2880.2);
//         // robot.frontRight.setVelocity(-.39*2880.2);
//         // robot.backRight.setVelocity(-.39*2880.2);
        
//         // sleep(1000);
        
//         double frontLeftTicks;
//         double frontRightTicks;
//         double backLeftTicks;
...
//       telemetry.addData("frontLeftTicks", robot.frontLeft.getVelocity());
                
                
//                 telemetry.addData("frontRightTicks", robot.frontRight.getVelocity());
                
                
//                 telemetry.addData("backLeftTicks", robot.backLeft.getVelocity());
                
                
//                 telemetry.addData("backRightTicks", robot.backRight.getVelocity());
//                 telemetry.update();
                
//                 sleep(10000);
        
        
//         // robot.frontLeft.setVelocity();
//         // robot.frontRight.setVelocity();
//         // robot.backLeft.setVelocity();
//         // robot.backRight.setVelocity();
        
        
//         // robot.frontLeft.setTargetPositionTolerance();
//         // robot.frontRight.setTargetPositionTolerance();
//         // robot.backLeft.setTargetPositionTolerance();
//         // robot.backRight.setTargetPositionTolerance();
