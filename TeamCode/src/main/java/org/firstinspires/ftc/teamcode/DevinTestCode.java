...
// /**
//  Because I know you two are unable to follow basic instructions and saw "Don't Touch" you decided to
//  see what I was doing, you also might have noticed that a lot of your codes had dissapeared from the
//  selection menue, they are still there, I just disabled them, they if you want them back just delete
//  the @Disabled under the @Autonomous that I put in. Now I made this becuase:
//  1) I didnt want to screw around with the inside of your code
//  2) your code is spagetti with all the commnted out code, you have to have at least 200 lines of it
 
//  Please, leave this code alone, and dont screw with it, I will be working on it hopefully during the
//  week when Im not at school so I'll update you on my progress on Saturday.
//  */

// @Autonomous(name="Devin's Test Code, dont touch Emily and David", group="2020/2021 auto programms")
// public class DevinTestCode extends LinearOpMode {
...
//         red = robot.colorSensor2.red();
//                 sleep(250);
                
//                 while(robot.colorSensor2.red() > 0) {
