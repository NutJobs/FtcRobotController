...
@Autonomous(name="RedBarCodeOne", group="2020/2021 auto programms") 
public class RedBarCodeOne extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
      ...
      // }
        ...
        //
        //Code here
        encoderDriveV2(0.1, -2, 1, 10);
        encoderDriveV2(0.1, -0.5, -0.5, 10);
        robot.wheelMotor.setPower(1);
        sleep(3000);
        robot.wheelMotor.setPower(0);

        encoderDriveV2(0.2, 3.75, 3.75, 10);
        ...
        encoderDriveV2(0.2, 0.5, -1, 10);
        encoderDriveV2(0.2, -6, -6, 10);
        /*
        robot.liftMotor.setPower(-0.5);
        sleep(900);
        robot.liftMotor.setPower(0);
