...
// @TeleOp(name="FreightFrenzyTele2", group="Drive programms")  // @Autonomous(...) is the other common choice

// public class FreightFrenzyTele2 extends LinearOpMode {
//     double rotations;
...
//     //ZEROS THE ENCODER ON LIFTMOTOR\\
...
//     int Encoder_rotation = 1;
//     int Target_one = 2*Encoder_rotation; 
...
//     int start = robot.liftMotor.getCurrentPosition();
        
//     while (opModeIsActive()) {
        

//         //robot.liftMotor.setCurrentPosition();
...
//       rotations += robot.liftMotor.getCurrentPosition();
//       //robot.liftMotor.setPower(-gamepad2.left_stick_y + gamepad2.left_stick_x);
...
//       robot.liftMotor.setTargetPosition(start);
       
//       //robot.liftMotor.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
//       robot.liftMotor.setVelocity(50);
//      }else{
